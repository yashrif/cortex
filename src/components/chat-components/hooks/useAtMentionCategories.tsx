...
/**
 * Hook that provides available @ mention categories based on Cortex Plus status.
 ...
 *
 * @param isCopilotPlus - Whether Cortex Plus features are enabled
