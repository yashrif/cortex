...
export class ChatOpenRouter extends ChatOpenAI {
   ...
   * Cortex Plus) use the same class but must not receive OpenRouter-specific fields.
   *
  ...
  override invocationParams(options?: this["ParsedCallOptions"]): Record<string, unknown> {
    ...
    // Only inject cache_control for OpenRouter endpoints. LM Studio, Cortex Plus, and
