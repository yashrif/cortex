...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/dynamic/json?logo=obsidian&color=%23483699&label=downloads&query=%24%5B%22cortex%22%5D.downloads&url=https%3A%2F%2Fraw.githubusercontent.com%2Fobsidianmd%2Fobsidian-releases%2Fmaster%2Fcommunity-plugin-stats.json&style=for-the-badge" alt="Obsidian Downloads">
</p>
...
- **🤖 Agent Mode (Plus)**: Unlock an autonomous agent with built-in tool calling. No commands needed. Cortex automatically triggers vault, web searches or any other relevant tool when relevant.
...
- [Cortex V3 is a New Era 🔥](#cortex-v3-is-a-new-era-)
- [Why People Love It ❤️](#why-people-love-it-️)
- [Get Started](#get-started)
  - [Install Obsidian Cortex](#install-obsidian-cortex)
  - [Set API Keys](#set-api-keys)
- [Usage](#usage)
  - [Free User](#free-user)
    - [**Chat Mode: reference notes and discuss ideas with Cortex**](#chat-mode-reference-notes-and-discuss-ideas-with-cortex)
    - [**Vault QA Mode: chat with your entire vault**](#vault-qa-mode-chat-with-your-entire-vault)
    - [Cortex's Command Palette](#cortexs-command-palette)
  ...
  - [Cortex Plus/Believer](#cortex-plusbeliever)
...
- [**FAQ**](#faq)
- [**🙏 Thank You**](#-thank-you)
- [**Cortex Plus Disclosure**](#cortex-plus-disclosure)
- [**Authors**](#authors)

## Cortex V3 is a New Era 🔥
...
2. Go to **Obsidian → Settings → Cortex → Basic** and paste the key into in the **Cortex Plus** card.
...
Cortex Plus brings powerful AI agentic capabilities, context-aware actions and seamless tool integration—built to elevate your knowledge work in Obsidian.
...
## **Cortex Plus Disclosure**

Cortex Plus is a premium product of Brevilabs LLC and it is not affiliated with Obsidian. It offers a powerful agentic AI integration into Obsidian. Please check out our website [obsidiancopilot.com](https://obsidiancopilot.com/) for more details!

- An account and payment are required for full access.
- Cortex Plus requires network use to facilitate the AI agent.
...
- The frontend code of Cortex plugin is fully open-source. However, the backend code facilitating the AI agents is close-sourced and proprietary.
