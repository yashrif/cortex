...
URL processing requires Cortex Plus. YouTube URLs are handled specially — Cortex will fetch the video transcript automatically.

### Tool Mentions

These special @-mentions explicitly trigger tools in Cortex Plus mode:
...
### Adding a PDF as Context (Cortex Plus)
