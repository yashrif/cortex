...
| ----------------------------- | ----------- | ----------------------- |
| cortex-plus-flash             | Cortex Plus | Vision (Plus exclusive) |
...
| Model                         | Provider                         |
| ----------------------------- | -------------------------------- |
| cortex-plus-small             | Cortex Plus (Plus exclusive)     |
| cortex-plus-large             | Cortex Plus (Believer exclusive) |
| cortex-plus-multilingual      | Cortex Plus (Plus exclusive)     |
