...
- **Used in**: Vault QA and Cortex Plus modes — but **disabled by default**. You must explicitly enable it.
...
| **ON MODE SWITCH** | Updates when you switch to Vault QA or Cortex Plus mode (Recommended) |
...
- [Cortex Plus and Self-Host](cortex-plus-and-self-host.md) — Miyo-powered local semantic search
