...
Cortex offers four modes. You can switch between them using the mode selector at the top of the chat panel.
...
The most powerful mode. Requires a [Cortex Plus](cortex-plus-and-self-host.md) license. Combines Chat and Vault QA with an autonomous agent that can:
